    ...
    const services = [
      {
        ...
        icon: 'Server',
        details: JSON.stringify(['RESTful & GraphQL APIs', 'Microservices architecture', 'Database optimization', 'Real-time data processing', 'Security implementation']),
      ...
      },
      {
        ...
        icon: 'Cloud',
        details: JSON.stringify(['CI/CD pipeline setup', 'Container orchestration', 'Auto-scaling solutions', 'Monitoring & logging', 'Cost optimization']),
      ...
      },
      {
        ...
        icon: 'Sparkles',
        details: JSON.stringify(['Custom AI models', 'Natural language processing', 'Computer vision integration', 'Recommendation systems', 'Predictive analytics']),
      ...
      },
      {
        ...
        icon: 'Palette',
        details: JSON.stringify(['Modern responsive design', 'Interactive animations', 'SEO optimization', 'CMS integration', 'Performance tuning']),
